...
$config = array(
    "api_key" => "2b150f3c00eb4b18b271",
    /*
     * Your API Key - This should be placed for you automatically when you download the package from CPABuild
     * You can see your API Key here: https://publishers.adbluemedia.com/apiKey (Public API key)
     */
    ...
    "default" => "install",
    /*
    * This is the default URI that is used when someone visits the root of your website
    * The default is "install" - this is a keyword that displays the installation process
    * Once installation is complete, you can change this to a private uri found here https://publishers.adbluemedia.com/privateURL (use the bold text in the "On Your Website" column).
    ...
    */
    ...
    "download_time" => 1765290722,
    /*
     * The UNIX timestamp of when this package was downloaded. Do not edit.
     */
